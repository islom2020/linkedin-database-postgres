create function add_user(i_first_name character varying, i_last_name character varying, i_region_id uuid, i_email character varying, i_about character varying DEFAULT NULL::character varying) returns boolean
    language plpgsql
as
$$
declare
