create function add_attachment(i_name character varying DEFAULT NULL::character varying,
                               i_content_type character varying DEFAULT NULL::character varying,
                               i_content character varying, i_size bigint DEFAULT NULL::bigint) returns uuid
    language plpgsql
as
$$
declare
